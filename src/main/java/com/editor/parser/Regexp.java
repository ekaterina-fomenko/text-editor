...
public class Regexp {
    ...
    public static final String ERLANG_RESERVED_WORDS = "(after|case|or|and|orelse|analso|cond|query|band|div|receive|rem|end|begin|bnot|bor|if|let|xor|bsl|bsr|not|of|bxor|try|when|ok|error|undefined|reply|noreply|stop|ignore)";
